...
export interface ScroungeForSatochisInterface extends utils.Interface {
  functions: {
...
export interface ScroungeForSatochis extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ScroungeForSatochisInterface;
